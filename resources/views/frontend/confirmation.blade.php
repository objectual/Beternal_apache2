    ...
    <div class="modal-content">
        <div class="modal-body">
            <div class="row pt-3 pb-5 media-icons mt-4">
                ...
                <div class="col-lg-3">
                    <a href="{{ route('index') }}">
                        <button class="filter-btn btn w-100 text-center py-2">REJECT</button>
                    </a>
                </div>
                <div class="col-lg-3">
                    <a href="{{ url('confirmation-success/'.$token) }}">
                        <button class="filter-btn btn w-100 text-center py-2">CONFIRM</button>
                    </a>
                </div>
                <div class="col-lg-3"></div>
            </div>
