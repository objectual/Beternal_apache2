        ...
        <div class="row">
            <div class="col-lg-4 m-auto mt-3">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-8 visa-picture">
                        <img class="mt-4" src="{{ asset('/public/assets/images/visa.png') }}" />
                    </div>
                ...
                <div class="col-md-7 m-auto pt-3 pb-3">
                    <label class="container-check check-color">SAVE CARD
                        <input type="checkbox" />
