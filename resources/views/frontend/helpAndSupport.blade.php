...
@section("content")
<div class="container-fluid bg-create mobile-padding pb-4 pt-5">
    <div class="scroll-div">
        <div class="col-md-10 m-auto">
            <h5 class="supp-heading text-white mb-3">SUPPORT HELP & SUPPORT TITLE</h5>
            <h5 class="supp-mob-heading text-white mb-3">HELP & SUPPORT TITLE</h5>
            <div class="accordion mb-3" id="accordionExample">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            Q &nbsp; How can I use beternal?
                        </button>
                    </h2>
